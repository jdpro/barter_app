 ...
 **/
 package troc.alertes {
	...
	import troc.Main;
	import troc.icones.IconeSourire;
	import troc.icones.IconeTriste;
	...
	public class Alerte extends Sprite {
		...
		private static const FOND_FAIBLE : uint = 0x9dcf04;
		private static const ERREUR : uint = 0xee293c;
		private static const JUSTE : uint = 0xFFFFFF;
		...
		private function masquerIcones() : void {
			iconeSourire.visible = iconeTriste.visible = false;
		}
		...
		private function determineFormatTexte() : void {
			switch(typeMessage) {
				case MESSAGE_ERREUR:
					formatTexte = new TextFormat(police.fontName, 22, ERREUR, true);
					break;
				case MESSAGE_FINAL:
					formatTexte = new TextFormat(police.fontName, 22, JUSTE, true);
					break;
			}
		}
